...
namespace GameProject3.Screens
{
    ...
    public class ParticleSystem : DrawableGameComponent
    {
        ...
        public ParticleSystem(Game game, int maxParticles,GraphicsDevice grd,ContentManager content) : base(game) 
        {
        ...
        protected override void LoadContent()
        {
            ...
            if (spriteBatch == null) spriteBatch = new SpriteBatch(gd);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (Particle p in particles)
            {
                ...
                spriteBatch.Draw(texture, p.Position, null, p.Color,
                    p.Rotation, origin, p.Scale, SpriteEffects.None, 1.0f);
            }
